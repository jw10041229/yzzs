 ...
 *
 */
public class FlzRFIDClFragment extends YzzsBaseFragment implements EventHandler,ConnectTimeoutListener,
					OnClickListener{
	...
	public View onYzzsInitView(LayoutInflater inflater, ViewGroup rootView,
		...
		View view = inflater.inflate(R.layout.activity_flz_rfid_cl_fragment, null);
		initView(view);
		initData();
		initListener();
		return view;
