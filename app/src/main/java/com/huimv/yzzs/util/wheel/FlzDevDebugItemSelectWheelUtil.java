...
public class FlzDevDebugItemSelectWheelUtil {
	...
	public FlzDevDebugItemSelectWheelUtil(Activity context, String titleStr, onDevDebugConfirmClickListener mOnConfirmClickListener) {
...
/*    public void setOnClickListener(final OnConfirmClickListener mOnConfirmClickListener) {  
	...
	public void showDialog() {
		...
		mItem.setViewAdapter(new ArrayWheelAdapter<>(context, context.getResources().getStringArray(R.array.flz_debug_wheel_string_item_array)));
