...
public class McZsItemSelectWheelUtil {
	private Activity context;
	private String titleStr;
	private int expenses_id;
	private String[] mczs; // 牧场名称或猪舍名称的数组
	/**
	 * WheelView控件
	 */
	private WheelView mItem;
	public McZsItemSelectWheelUtil(Activity context, String titleStr, String[] mczs,OnConfirmClickListener mOnConfirmClickListener) {
...
/*    public void setOnClickListener(final OnConfirmClickListener mOnConfirmClickListener) {  
	...
	public void showDialog() {
		...
		mItem.setViewAdapter(new ArrayWheelAdapter<>(context,mczs));
					...
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog,
							...
							if (mOnConfirmClickListener != null) {  
								mOnConfirmClickListener.onConfirm(expenses_id);
							}
							dialog.dismiss();
						}
					})
